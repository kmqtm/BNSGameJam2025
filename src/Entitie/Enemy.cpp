#include "../AI/BehaviorStrategies.h"
#include "../Component/Animation.h"
#include "../System/EnemyDataSystem.h"
...
namespace
{
	Animation ToAnimation(const EnemyDataSystem::AnimationSpec& spec)
	{
		Animation a;
...
{
	// 仕様の取得
	auto specOpt = EnemyDataSystem::GetInstance().TryGetSpec(type);
	if(not specOpt)
	{
	...
	else if(spec.behavior == EnemyDataSystem::BehaviorKind::BackAndForth)
	{
	...
	// collider
	if(spec.collider_shape == EnemyDataSystem::ColliderKind::Circle)
	{

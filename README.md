...
* **Code:** [`AI/IBehaviorStrategy.h`](AI/IBehaviorStrategy.h), [`AI/BehaviorStrategies.cpp`](AI/BehaviorStrategies.cpp)

### 2. JSONによるデータ駆動 (Data-Driven)
キャラクターのパラメータ(速度，物理サイズ，アニメーション設定など)をJSONファイルに分離．
コンパイル不要でゲームバランスの調整が可能となっています．

* **Code:** [`System/EnemyDataSystem.cpp`](System/EnemyDataSystem.cpp)
* **Data:** `asset/EnemyData.json`
